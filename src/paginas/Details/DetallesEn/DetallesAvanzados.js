...
export default function DetallesAvanzados({ datapokByform }) {
    ...
    return (
                    <>
                        ...
                        {areBothSelected? <DetallesAtaques fastTrue={fastTrue} chargedTrue={chargedTrue}/>: isSmeargle? <p>Smeargle doesn´t attack</p> :<p> Do you want the details of all combinations of attacks? select the attacks that you want to combine</p>}
